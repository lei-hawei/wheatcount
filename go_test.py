import os
os.system("python val.py --data my_data.yaml --weights checkpoints/best.pt --img 640") # s模型测试
...
# os.system("python val.py --data my_data.yaml --weights runs/train/expn/weights/best.pt --img 640") # n模型测试